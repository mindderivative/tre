...
(`App.add_rect`), animates its opacity from Python (`Node.animate`,
...
app = App(width=420, height=140)

swatch = app.add_rect(background=(0x67, 0x50, 0xA4, 0xFF), width=100, height=100)
swatch.animate("opacity", 0.3, duration_ms=800)
swatch.animate("corner_radius", 24.0, duration_ms=800)

second = app.add_rect(background=(0x03, 0xDA, 0xC6, 0xFF), width=100, height=100)
