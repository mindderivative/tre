...
const BLACK: Color = Color::from_rgba8(0x00, 0x00, 0x00, 0xFF);
const GREEN: Color = Color::from_rgba8(0x00, 0xFF, 0x00, 0xFF);
...
impl Frame {
    async fn of(tree: &Tree, root: NodeId) -> Self {
    ...
    fn any_in(&self, x0: u32, y0: u32, x1: u32, y1: u32, test: impl Fn([u8; 4]) -> bool) -> bool {
