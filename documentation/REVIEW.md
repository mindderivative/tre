...
**Status: Option 2 and Option 3 are both implemented, independently selectable, and objectively measured; the choice between them (or a further-tuned variant, e.g. a looser acquire timeout to trade fewer drops for a higher worst-case bound) is the project owner's own call, pending their direct comparison of how each one actually feels during a real drag.**
