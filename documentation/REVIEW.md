...
**Status: in progress.** Seven of eight CI jobs green and stable; the `python` job's demo step is instrumented for a decisive next run. Findings #255 and #256 are complete and independent of this.
