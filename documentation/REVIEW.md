...
**Status: closed.** No further action pending; both the squash/stretch defect and the residual resize-time resample are now understood, measured, and minimized within the shipped technique's own real limits.
