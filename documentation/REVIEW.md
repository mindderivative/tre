...
## Finding #227 Investigated, Not Resolved: The `frame_processing` Optimization (Finding #224) Measured *Worse* on CI's Own Hardware, Despite a Real, Repeatable Local Improvement
