...
**Status: fixed for the Python boundary; final CI run pending.** With this, all five owner-directed bumps, the two Security/Architecture items (#255/#256), and every diagnosed `python`-job failure (#254/#257/#258) are addressed; the remaining unknown is only whether a further, unrelated demo trips on the runner.
