...
Not yet started: Sections 2-5 (Text as a first-class `ShapePrimitive` + `FontRegistry`; `Font`/`Text` Python API; Gradient/Texture Python fill API; the full `Canvas` redesign around clip/layer/accessibility semantics).
